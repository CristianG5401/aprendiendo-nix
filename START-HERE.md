...
4. **Usa las referencias rápidas cuando te atasques**
...
6. **Después de completar la lección 0002**
   - Vuelve al chat y dime: `completé la lección 0002`.
   - Si falló algo, pega el error exacto.
   - Siguiente tema sugerido: `flake.nix` + `flake.lock` para reproducibilidad más fuerte.
...
```bash
xdg-open ~/estudio/linux/nix/lessons/0002-lectura-basica-del-lenguaje-nix.html
```
